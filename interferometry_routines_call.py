...
#tchunk = 0.2  #sec
tchunk = 0.05  #sec
coh, phase, tchunks, freqs = correlation_analysis.cross_spectral_density_spectrogram(wfA,wfB,tdat,fs,tchunk,coh_min=0.,nperseg=512)
...
ps.plot_spectrogram(tchunks,freqs,phase,vr=[0,140],zscale='linear',xr=xr,yr=yr,yscale='linear',ax=axs[2],xlabel='time(s)',ylabel='Phase\nf(Hz)')
...
print('h')
#axs[1].secondary_xaxis("bottom", functions=(k2,kvals))
